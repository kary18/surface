...
function createDepartement($depCode, $depNom)
{
    ...
    $stmt1 = $dbh->prepare("INSERT INTO departement (dept_code, departement_nom) VALUES (:dept_code, :departement_nom)");
    
    $stmt1->bindValue(':dept_code' , $depCode, PDO::PARAM_STR);
    $stmt1->bindValue(':departement_nom' , $depNom, PDO::PARAM_STR);
    if ($stmt1->execute() ) {
